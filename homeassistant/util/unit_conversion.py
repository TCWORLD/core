...
class BaseUnitConverter:
    ...
    def converter_factory(
        ...
        return BaseUnitConverter._converter_factory(convert_ops[:])
    ...
    def converter_factory_allow_none(
        ...
        if from_unit == to_unit:
            return lambda val: val
        convert_ops = cls._get_from_to_ops(from_unit, to_unit)
        return BaseUnitConverter._converter_factory_allow_none(convert_ops[:])
    ...
    @staticmethod
    def _converter_factory(ops: list[UnitConvertOp]) -> Callable[[float], float]:
        return lambda val: BaseUnitConverter._convert_fn(val, ops)
    ...
    @staticmethod
    def _converter_factory_allow_none(
        ops: list[UnitConvertOp],
    ) -> Callable[[float | None], float | None]:
        return lambda val: BaseUnitConverter._convert_allow_none_fn(val, ops)
